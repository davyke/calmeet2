...
const VideoRoom= () => {
  ...
  const rtcProps = {
    ...
    token: '007eJxTYPCb4LRwqVWjYuplPVmxrY5H9bfGWedmVsxhf1QieNT+drICg4mheaqxUYqZRbKJkYmZoaGFYVKicWqSYZJJmoGRoXHKl2+JKQ2BjAzOLLHMjAwQCOJzMDgn5iSX5pQWMzAAAAgUHno=' // use null or skip if using app in testing mode
  };
  const callbacks = {
