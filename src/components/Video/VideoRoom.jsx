...
const VideoRoom= () => {
  ...
  const rtcProps = {
    ...
    token: '007eJxTYDj6oOCXDnfd5fZbGz4wtHuUVC964GPvrp6bvruXcc+L/t0KDCaG5qnGRilmFskmRiZmhoYWhkmJxqlJhkkmaQZGhsYpcVdzUxoCGRlWsR5mZGSAQBCfg8E5MSe5NKe0mIEBACivIco=' // use null or skip if using app in testing mode
  };
  const callbacks = {
